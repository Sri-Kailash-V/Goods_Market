...
ActiveRecord::Schema.define(version: 20200204093014) do
  ...
  create_table "custs", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    ...
    t.datetime "created_at",               null: false
    t.datetime "updated_at",               null: false
    t.index ["email"], name: "index_custs_on_email", unique: true, using: :btree
  end

  create_table "mfrs", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string   "username"
    t.string   "password"
    t.integer  "mobile_no"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string   "email"
    t.index ["email"], name: "index_mfrs_on_email", unique: true, using: :btree
  end

  create_table "mproducts", primary_key: "pid", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
